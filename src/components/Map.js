...
const Map = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-10">
      <h1 className="text-4xl font-bold text-center text-blue-800 mb-8">Let's Find the Best Meeting Location for you!</h1>
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-6">
        ...
        {saved && (
          <p className="text-center text-green-600 mt-4 font-semibold">✅ 출발지가 저장되었습니다!</p>
        )}
